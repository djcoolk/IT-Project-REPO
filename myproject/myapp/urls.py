...
urlpatterns = [
    ...
    path('user_rebook/<int:booking_id>/', views.user_rebook, name='user_rebook'),
    path('counsellor/cancel_booking/<int:booking_id>/', views.counsellor_cancel_booking, name='counsellor_cancel_booking'),
    path('counsellor/rebook/<int:booking_id>/', views.counsellor_rebook, name='counsellor_rebook'),
